...
class utils:
    ...
    def banner():
        ...
        utils.Go("\t" + utils.Color['redBold'] + " ____ ___ _   _ ____")
        utils.Go("\t" + utils.Color['redBold'] + "| __ )_ _| \ | / ___| _ __  _   _ ")
        utils.Go("\t" + utils.Color['redBold'] + "|  _ \| ||  \| \___ \| '_ \| | | |")
        utils.Go("\t" + utils.Color['redBold'] + "| |_) | || |\  |___) | |_) | |_| |")
        utils.Go("\t" + utils.Color['redBold'] + "|____/___|_| \_|____/| .__/ \__, |")
        utils.Go("\t" + utils.Color['redBold'] + "                     |_|    |___/")
        utils.Go("\t" + utils.Color['redBold'] + " " + utils.Color['white'] + " By " + utils.Color['whiteBold'] + "ALIF101XL" + utils.Color['white'] + " (" + utils.Color['blue'] + "@ALIF101XL" + utils.Color['white'] + ")" + utils.Color['white'])
        utils.Go("\t" + "-----------------------------------------------")
    ...
    def checkOS():
        if "posix" in os.name:
            ...
            pass
        utils.Go("Loading" + " " + utils.Color['blue'] + "BINSpy" + utils.Color['white'] + "...")
        time.sleep(0.4)
    ...
    # Local port check to allow BINSpy to run    
    @staticmethod
    def checkPort(port):
        try:
